  ...
  return (
    <div className="w-full fixed top-2 flex justify-center px-2 sm:px-4 z-30">
      <div className={`w-full flex items-center justify-between px-2 sm:px-4 py-2 sm:py-4`}>
        <AnimatedButton onClick={() => push('#hero-section')} id="zyka-ai-logo" className="cursor-none text-xs sm:text-sm uppercase tracking-wider shadow-2xl rounded-full inline-flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-1.5 sm:py-2">
          ZYKA AI
        </AnimatedButton>
