    ...
    >
      <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6 px-2 sm:px-0">
        <motion.div
          ...
          className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 md:p-8 border border-gray-700/50 text-center mb-6 sm:mb-8"
        >
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">Why Work at ZYKA AI?</h2>
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 sm:gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm sm:text-base text-gray-400 mb-3 sm:mb-4">{job.description}</p>
                ...
                <AnimatedButton
                  className="rounded-lg bg-blue-500 text-white hover:bg-blue-600 px-4 sm:px-6 py-2 text-sm sm:text-base w-full md:w-auto"
                >
                  Apply Now
                </AnimatedButton>
              </div>
